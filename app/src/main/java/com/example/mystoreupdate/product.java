                    ...
                    submit.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            if (pName.getText().toString().isEmpty() || productImg.getText().toString().isEmpty() || pPrice.getText().toString().isEmpty() || cat.getSelectedItem() == null || cat.getSelectedItemPosition() == 0 || cWeight.getText().toString().isEmpty() || HName.getText().toString().isEmpty()) {
                                ...
                                productData ob = new productData(mImageUrl, pPrice.getText().toString(), pName.getText().toString(), cWeight.getText().toString(), HName.getText().toString(), "yes");
...
*/
                           ...
                           /* bitmap.compress(Bitmap.CompressFormat.JPEG, 20, stream);
                            ...
                            Log.d("checkSize",""+sizeBefor+" "+sizeImg);
*/
                            //TODO check logic follow
                            String str12 = cat.getSelectedItem().toString();
                            String str1 = spinner.getSelectedItem().toString();
                    ...
                    .addOnSuccessListener(
                            taskSnapshot -> {
                                storageRef.getDownloadUrl().addOnSuccessListener(uri -> {
                                    ...
                                    productData ob = new productData(mImageUrl, pPrice.getText().toString(), pName.getText().toString(), str1, HName.getText().toString(), "yes");

                                    ref = FirebaseDatabase.getInstance().getReference("CategoryProducts").child(str12).child(pName.getText().toString());
                                    ref.setValue(ob);
                                    Toast.makeText(product.this, "Successfully Added ", Toast.LENGTH_SHORT).show();
                                    ...
                                    Toast.makeText(product.this, "Image Uploaded!!", Toast.LENGTH_SHORT).show();
                                });
                            })
                    .addOnFailureListener(e -> Toast.makeText(product.this, "Failed " + e.getMessage(), Toast.LENGTH_SHORT).show())
